...
/// after a certain amount of time, the snackbar shows a button that offers to open a help window with
...
public class PlaneDiscoveryGuide : MonoBehaviour
{
    ...
    [SerializeField]
    private ARPointCloudManager _featurePoints = null;
    ...
    public void EnablePlaneDiscoveryGuide(bool guideEnabled)
    {
        ...
        {
            enabled = false;
            foreach (var point in _featurePoints.trackables)
            {
